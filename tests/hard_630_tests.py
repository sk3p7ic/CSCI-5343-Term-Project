...
from chatgpt_hard_630 import Solution as SolutionChatGPT
from claude_hard_630 import Solution as SolutionClaude
from gemini_hard_630 import Solution as SolutionGemini
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'test':
        ...
        print(f'hard_630,{sys.argv[2]},', end='')
